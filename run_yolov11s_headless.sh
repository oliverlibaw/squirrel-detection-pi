...
# YOLOV11s Webcam Detection Launcher Script (Headless Version)
# This script activates the virtual environment and runs the YOLOV11s detection in headless mode

echo "Starting YOLOV11s Webcam Detection (Headless Mode)..."
...
echo "Running YOLOV11s detection in headless mode..."
echo "Frames will be saved to: detection_output/"
echo "Press Ctrl+C to stop"
echo ""

# Run the detection script
python webcam_yolov11s_detection_headless.py --model-path "$MODEL_PATH" "$@"

# Deactivate virtual environment
deactivate

echo "Detection finished."
echo "Check the 'detection_output/' directory for saved frames." 